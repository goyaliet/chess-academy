...
export const tacticsPuzzles: Puzzle[] = [
  ...
  {
    id: "tac-fork-3",
    title: "Italian Attack — Double Threat on f7!",
    fen: "r1bqk2r/pppp1ppp/2n2n2/2b1p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 1",
    solution: "Ng5",
    hint: "Your knight AND your bishop both have their eye on f7 — send the knight in!",
    explanation:
      "Ng5! The knight leaps to g5, creating a deadly double attack on f7. Both your knight (on g5) and your bishop (on c4) now target f7 — a square only defended by Black's king. If Black fails to defend, Nxf7 wins the rook on h8 and the queen on d8 simultaneously. This is the most important attacking idea in the Italian Game!",
    type: "fork",
    difficulty: "intermediate",
  },
  {
    ...
    fen: "8/8/q3k3/8/8/3N4/8/4K3 w - - 0 1",
    solution: "Nc5",
    hint: "Find the square where your knight attacks both the king and the queen at once!",
    explanation:
      "Nc5+! The knight jumps to c5, simultaneously checking the king on e6 AND attacking the queen on a6. The king must move out of check — and then you capture the queen for free. This is a 'royal fork': one knight attacking the two most important pieces on the board. Knights are unique because they can attack pieces of any value without being captured in return — always look for knight forks!",
    type: "fork",
    difficulty: "intermediate",
  },
  {
  ...
  },
  {
    ...
    fen: "4k3/8/8/8/4B3/1q6/8/4RK2 w - - 0 1",
    solution: "Bc2",
    hint: "Move the bishop OFF the e-file to reveal the rook — but also attack the queen!",
    explanation:
      "Bc2+! A double blow: moving the bishop off the e-file unleashes a discovered check from the rook on e1 straight to the king on e8 — AND the bishop on c2 simultaneously attacks the queen on b3. Black must deal with the check first, and then you capture the queen. This is the power of discovered attacks: you threaten two things at once, and your opponent can only stop one!",
    type: "tactic",
    difficulty: "intermediate",
  },
  {
